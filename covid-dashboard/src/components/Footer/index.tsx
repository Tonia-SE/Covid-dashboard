    ...
    return (
        <div className='page-footer font-small blue pt-4'>
          ...
          <div className="footer-copyright text-right py-3">
            <p>© 2020 Copyright:</p>
            <a href="https://github.com/Tonia-SE" target="blank">https://github.com/Tonia-SE<br/></a>
            <a href="https://github.com/Tonia-SE" target="blank">https://github.com/pannage<br/></a>
